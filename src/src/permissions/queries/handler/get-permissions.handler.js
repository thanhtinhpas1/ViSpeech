...
let GetPermissionsHandler = class GetPermissionsHandler {
    ...
    execute(query) {
        return __awaiter(this, void 0, void 0, function* () {
            common_1.Logger.log('Async GetPermissionsHandler...', 'GetPermissionsQuery');
            ...
            try {
                ...
                common_1.Logger.error(error, '', 'GetPermissionsQuery');
            }
        });
    }
};
GetPermissionsHandler = __decorate([
    cqrs_1.QueryHandler(get_permissions_query_1.GetPermissionsQuery),

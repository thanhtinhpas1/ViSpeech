...
let ReportRepository = class ReportRepository {
    createReport(streamId, reportDto) {
        return __awaiter(this, void 0, void 0, function* () {
            const report = new report_model_1.Report(undefined);
    ...
    deleteReport(streamId, reportId) {
        return __awaiter(this, void 0, void 0, function* () {
            const report = new report_model_1.Report(reportId);
            report.deleteReport(streamId);
            return report;
        });
    }
    welcomeReport(streamId, reportId) {
        return __awaiter(this, void 0, void 0, function* () {
            const report = new report_model_1.Report(reportId);

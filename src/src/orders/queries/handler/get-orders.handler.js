...
let GetOrdersHandler = class GetOrdersHandler {
    ...
    execute(query) {
        return __awaiter(this, void 0, void 0, function* () {
            common_1.Logger.log('Async GetOrdersQuery...', 'GetOrdersQuery');
            ...
            try {
                ...
                common_1.Logger.error(error, '', 'GetOrdersQuery');
            }
        });
    }
};
GetOrdersHandler = __decorate([
    cqrs_1.QueryHandler(get_orders_query_1.GetOrdersQuery),

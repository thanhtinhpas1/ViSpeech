...
;(function() {
  if (
    (isWindows || isLinux) &&
    !($('body').hasClass('sidebar-mini') || $('body').hasClass('compact-menu') || $('body').hasClass('rtl-layout'))
  ) {
...
var md = {
  ...
  initBootstrapNavbarMenu: debounce(function() {
    if (!bootstrap_nav_initialized) {
      ...
      $navbar
        .find('button')
        .removeClass('btn-round btn-fill btn-info btn-primary btn-success btn-danger btn-warning btn-neutral')

...
const PayReviewModal = ({ payReviewModal }) => {
  return (
    <Modal visible={ payReviewModal.visible } footer={ null } centered width={ 600 }
           onCancel={ payReviewModal.onCancel }>
      <div className="popup-body text-center">
        ...
        <p style={ { color: '#495463' } }>Thời hạn sử dụng API key là { payReviewModal.data.minutes } phút. Xin cảm
          ơn.</p>

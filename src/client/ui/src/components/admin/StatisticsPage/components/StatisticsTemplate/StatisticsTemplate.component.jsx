  ...
  return (
    <div style={{ position: 'relative' }}>
      ...
      <div className="admin-statistics-page__select-type">
        ...
        <div className="col-xs-12 col-sm-6 col-md-6 col-lg-4 mt-2">
        ...
        <div className="col-xs-12 col-sm-6 col-md-2 col-lg-2 mt-2">
      ...
      <Row justify="center">
        <div className="admin-statistics-page__chart">
